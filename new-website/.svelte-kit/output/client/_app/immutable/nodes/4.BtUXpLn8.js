import"../chunks/CWj6FrbW.js";import"../chunks/69_IOA4Y.js";import{t as P,$ as A,s as e,c as a,n as i,r as t}from"../chunks/CZU13uu7.js";import{h as W}from"../chunks/BMb5llEB.js";import{f as $,a as q}from"../chunks/YpWQREtn.js";import{s as o}from"../chunks/CNxcTYsu.js";import{b as r}from"../chunks/Bn7YRmJN.js";import{d as f}from"../chunks/DeY6Grmj.js";var x=$(`<div class="content"><h1>About</h1> <p>This page has information about our club and what we do. If you have a question we don't answer
		here, feel free to ask in <a>the Discord server</a> or to <a>message an officer</a>.</p> <h2>What is competitive programming?</h2> <p>Competitive programming is pretty much exactly what it sounds like. You (and a team, usually)
		...
		competitive programming competitions, like <a>ICPC</a>. To prepare, we give
		...
		code' or 'no control flow').</p> <p>If you have any other questions about what we do, feel free to <a>contact the leadership team</a></p> <h2>Who can join? How can I join?</h2> <p>Anyone can attend meetings! All you have to do is show up. Upcoming events, including times and
		room numbers, can be found on the <a>schedule page</a>. If you're
		...
		occurs during the August semester.</p> <p>For more information, check out <a>our page on the competition</a> or <a href="https://icpc.global/" target="_blank">ICPC's official website</a>.</p> <h2>I'd to help out with the club!</h2> <p>Thanks for your interest! Direct message someone in the <a>leadership team</a> and we can discuss what you're interested in and where you could contribute.</p> <h2>I have so many more questions.</h2> <p>The <a>Discord server</a> is a great place for questions! You can also check
		out the <a>leadership page</a> for more options.</p></div>`);function L(v){var n=x();W(D=>{A.title="About"});var s=e(a(n),2),d=e(a(s)),w=e(d,2);i(),t(s);var h=e(s,8),y=e(a(h));i(),t(h);var m=e(h,6),b=e(a(m));t(m);var p=e(m,4),C=e(a(p));i(),t(p);var l=e(p,12),k=e(a(l));i(3),t(l);var c=e(l,4),_=e(a(c));i(),t(c);var u=e(c,4),g=e(a(u)),I=e(g,2);i(),t(u),t(n),P(()=>{o(d,"href",f),o(w,"href",`${r??""}/leadership`),o(y,"href",`${r??""}/icpc`),o(b,"href",`${r??""}/leadership`),o(C,"href",`${r??""}/schedule`),o(k,"href",`${r??""}/icpc`),o(_,"href",`${r??""}/leadership`),o(g,"href",f),o(I,"href",`${r??""}/leadership`)}),q(v,n)}export{L as component};
