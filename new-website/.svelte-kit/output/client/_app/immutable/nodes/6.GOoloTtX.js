import"../chunks/CWj6FrbW.js";import"../chunks/69_IOA4Y.js";import{s as e,f as l,t as c,$ as p,c as m,n as i,r as d}from"../chunks/CZU13uu7.js";import{h as f}from"../chunks/BMb5llEB.js";import{f as u,a as v}from"../chunks/YpWQREtn.js";import{s}from"../chunks/CNxcTYsu.js";import{b as r}from"../chunks/Bn7YRmJN.js";var g=u(`<h1>The International Collegiate Programming Competition</h1> <img alt="" class="svelte-19rnwgt"/> <div class="after-image svelte-19rnwgt"></div> <p>ICPC is an annual international programming competition that we participate in. The competition
	has multiple levels, and participants that do the best at each level advance to the next. For more
	detailed information, visit <a href="https://icpc.global/">ICPC's website</a>. Feel free to <a>direct any questions at the club's leadership team</a>.</p> <h2>Format</h2> <p>ICPC consists of multiple contests at different levels of regionality. Each contest has roughly
	...
	Finals one time in 2016. Your team could be the next!</p>`,1);function F(n){var t=g();f(b=>{p.title="ICPC"});var a=e(l(t),2),o=e(a,4),h=e(m(o),3);i(),d(o),i(22),c(()=>{s(a,"src",`${r??""}/image/ecna24.jpg`),s(h,"href",`${r??""}/leadership`)}),v(n,t)}export{F as component};
